...
import com.haleydu.cimoc.databinding.ItemLoadingBinding;
import com.haleydu.cimoc.databinding.ItemPictureBinding;
import com.haleydu.cimoc.databinding.ItemPictureStreamBinding;
...
public class ReaderAdapter extends BaseAdapter<ImageUrl> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_IMAGE) {
            if (reader == READER_PAGE) {
                return new ImageHolder(ItemPictureBinding.inflate(mInflater, parent, false).getRoot());
            }
            return new ImageHolder(ItemPictureStreamBinding.inflate(mInflater, parent, false).getRoot());
        }
        return new ImageHolder(ItemLoadingBinding.inflate(mInflater, parent, false).getRoot());
    }
    ...
    public static class ImageHolder extends BaseViewHolder {
        ...
        ImageHolder(RetryDraweeView view) {
            super(view);
            draweeView = view;
        }
    }
