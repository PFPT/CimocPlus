...
public class AppEvent {
    ...
    public AppEvent(@EventType int type, Object... data) {
        this.type = type;
        this.data = data;
    }
    ...
    @IntDef({EVENT_COMIC_FAVORITE, EVENT_COMIC_UNFAVORITE, EVENT_COMIC_READ, EVENT_COMIC_UPDATE, EVENT_COMIC_FAVORITE_RESTORE,
            EVENT_COMIC_HISTORY_RESTORE, EVENT_COMIC_CANCEL_HIGHLIGHT, EVENT_COMIC_UPDATE_INFO, EVENT_TASK_STATE_CHANGE, EVENT_TASK_PROCESS,
